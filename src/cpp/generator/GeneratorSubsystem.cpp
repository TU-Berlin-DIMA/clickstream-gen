...
#include "generator/RequestGenerator.h"
...
void GeneratorSubsystem::registerGenerators()
{
	...
	registerGenerator<ClickStreamGen::ProductGenerator>("product");
	registerGenerator<ClickStreamGen::RequestGenerator>("request");
	registerGenerator<ClickStreamGen::SessionGenerator>("session");
	registerGenerator<ClickStreamGen::UserGenerator>("user");
}
